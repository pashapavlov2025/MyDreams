...
const en: Record<TranslationKey, string> = {
  ...
  'accountForm.metadataTitle': 'Family access details',
  'accountForm.metadataHint': 'No passwords or full card numbers — just pointers',
  'accountForm.contractNumber': 'Contract / account number',
  'accountForm.contractNumberPlaceholder': 'Contract or account number',
  'accountForm.managerName': 'Manager',
  'accountForm.managerNamePlaceholder': "Manager's name",
  'accountForm.managerPhone': 'Manager phone',
  'accountForm.managerPhonePlaceholder': '+1...',
  'accountForm.managerEmail': 'Manager email',
  'accountForm.managerEmailPlaceholder': 'manager@bank.com',
  'accountForm.organizationAddress': 'Organization address',
  'accountForm.organizationAddressPlaceholder': 'Mailing or legal address',
  'accountForm.accessMethod': 'How access works',
  'accountForm.accessMethodPlaceholder': 'App, SMS, in-branch only...',
  'accountForm.country': 'Country',
  'accountForm.countryPlaceholder': 'USA, UAE, Thailand...',
  'accountForm.documentsLocation': 'Where documents are stored',
  'accountForm.documentsLocationPlaceholder': 'Folder, safe, with notary...',
  'accountForm.beneficiary': 'Heir / beneficiary',
  'accountForm.beneficiaryPlaceholder': 'Is one set, full name',
  'accountForm.notes': 'Notes',
  'accountForm.notesPlaceholder': 'Anything else that matters',
  ...
  'familyExport.sectionTitle': 'Family access',
  'familyExport.sectionHint': 'Export a map with all accounts, details, and contacts — a file anyone can open without the app.',
  'familyExport.export': 'Export access map',
  'familyExport.exporting': 'Preparing file...',
  'familyExport.shared': 'File shared',
  'familyExport.downloaded': 'File downloaded',
  'familyExport.failed': 'Could not export file',
  'familyExport.readyCount': 'Accounts with details',
  'familyExport.title': 'Asset access map',
  'familyExport.subtitle': 'Profile',
  'familyExport.generatedAt': 'Generated',
  'familyExport.disclaimer': 'Important',
  'familyExport.noPasswords': 'This document contains no passwords, PINs, seed phrases, or full card numbers. Only pointers: where the account is, who to contact, and how access works.',
  'familyExport.lastUpdate': 'Balance last updated',
  'familyExport.noRecords': 'No accounts to export.',
  'familyExport.contractNumber': 'Contract / account',
  'familyExport.manager': 'Manager',
  'familyExport.organizationAddress': 'Organization address',
  'familyExport.accessMethod': 'How access works',
  'familyExport.country': 'Country',
  'familyExport.documentsLocation': 'Where documents are stored',
